-------------------------------------------------
-- ZaiiaPawn Defaults/Helpers.lua
-------------------------------------------------
defaultWeights = defaultWeights or {}

-- Compatibility aliases so existing default weight files work unchanged.
OctoPawn_Merge = OctoPawn_Merge or function(base, over)
    local t = {}
...
OctoPawn_Fill = OctoPawn_Fill or function(t)
    local keys = {
...
OctoPawn_MeleeDPS = OctoPawn_MeleeDPS or function(o)
    return OctoPawn_Fill(OctoPawn_Merge({
        STRENGTH = 1.0, AGILITY = 1.0, STAMINA = 0.45, INTELLECT = 0.05, SPIRIT = 0.05,
        ARMOR = 0.01, DEFENSE = 0.15, DODGE = 1.2, PARRY = 1.2, BLOCK = 0.2,
        ["BLOCK VALUE"] = 0.1,
        ...
        ["FIRE RESISTANCE"] = 0.12, ["FROST RESISTANCE"] = 0.12,
        ["SHADOW RESISTANCE"] = 0.12, ["NATURE RESISTANCE"] = 0.12,
        ["ARCANE RESISTANCE"] = 0.12, ["ALL RESISTANCES"] = 0.45,
        ["MOUNT SPEED"] = 0.08, ["MOVEMENT SPEED"] = 0.2,
    }, o))
end

OctoPawn_Tank = OctoPawn_Tank or function(o)
    return OctoPawn_Fill(OctoPawn_Merge({
        STRENGTH = 0.85, AGILITY = 0.85, STAMINA = 1.6, INTELLECT = 0.1, SPIRIT = 0.1,
        ARMOR = 0.02, DEFENSE = 2.6, DODGE = 2.6, PARRY = 2.4, BLOCK = 2.1,
        ["BLOCK VALUE"] = 1.15,
        ...
        ["FIRE RESISTANCE"] = 0.25, ["FROST RESISTANCE"] = 0.25,
        ["SHADOW RESISTANCE"] = 0.25, ["NATURE RESISTANCE"] = 0.25,
        ["ARCANE RESISTANCE"] = 0.25, ["ALL RESISTANCES"] = 0.9,
        ["MOUNT SPEED"] = 0.08, ["MOVEMENT SPEED"] = 0.15,
    }, o))
end

OctoPawn_CasterDPS = OctoPawn_CasterDPS or function(o)
    return OctoPawn_Fill(OctoPawn_Merge({
...
OctoPawn_Healer = OctoPawn_Healer or function(o)
    return OctoPawn_Fill(OctoPawn_Merge({
        ...
        HEALING = 1.35, ["SPELL HIT"] = 0.4, ["SPELL CRIT"] = 1.25,
        ["SPELL PENETRATION"] = 0.2,
        ["FIRE RESISTANCE"] = 0.12, ["FROST RESISTANCE"] = 0.12,
        ["SHADOW RESISTANCE"] = 0.12, ["NATURE RESISTANCE"] = 0.12,
        ["ARCANE RESISTANCE"] = 0.12, ["ALL RESISTANCES"] = 0.5,
        ["MOUNT SPEED"] = 0.08, ["MOVEMENT SPEED"] = 0.2,
    }, o))
end
